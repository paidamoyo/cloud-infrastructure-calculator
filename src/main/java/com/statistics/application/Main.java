...
import com.statistics.application.view.StatisticsFileWriter;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        StringBuilder results = new CloudInfrastructureOutput(customers, hosts, new StatisticsFileWriter()).display();
